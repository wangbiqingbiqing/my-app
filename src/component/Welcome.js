    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                <AppBar position="static">
                    <Toolbar>
                        ...
                        >
                            ...
                            <BottomNavigationAction label="Album"  />
                            <BottomNavigationAction label="Groccery" />
                        </BottomNavigation>
                ...
                {renderMenu}
                {renderMobileMenu}
                <div><Typography variant="h3" color="inherit" noWrap>Welcome to Juno's World</Typography></div>
            </div>
        );
    }
}
